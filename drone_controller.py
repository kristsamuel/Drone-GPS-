...
DRONE_MASS_KG = 0.5    #input drone mass
GRAVITY = -9.81        #gravity constant
MOI = np.array([0.005, 0.005, 0.01])  #other parameter for the drone
MAX_THRUST = 10.0      #maximal thrust for the drone
MAX_TORQUE = 1.0       #maximal torque for the drone
MAX_TILT_ANGLE = 0.8   #maximal tilting angle for the drone

class NonlinearController(object):
#non-linear variables for the drone - x,y,z coordinates, pitch,roll,yaw and p,q,r angles
    ...
    def trajectory_control(self, position_trajectory, yaw_trajectory, time_trajectory, current_time):
        ...
        #   yaw_trajectory: #list_yaw_commands in radians
